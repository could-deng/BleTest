...
public class AppMsg {
    ...
    /**
     * Make a {@link AppMsg} with a custom layout. The layout must have a {@link TextView} com id message
     *
     * @param context The context to use. Usually your
     *                {@link Activity} object.
     * @param text    The text to show. Can be formatted text.
     * @param style   The style with a background and a duration.
     */
    private static AppMsg makeText(Activity context, CharSequence text, Style style, int layoutId) {
     ...
     * @param style   The style with a background and a duration.
     */
    private static AppMsg makeText(Activity context, CharSequence text, Style style, int layoutId, float textSize, OnClickListener clickListener) {
        LayoutInflater inflate = (LayoutInflater)
                context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        View v = inflate.inflate(layoutId, null);
     ...
     * @param style   The style with a background and a duration.
     */
    private static AppMsg makeText(Activity context, CharSequence text, Style style, int layoutId, float textSize) {
        LayoutInflater inflate = (LayoutInflater)
                context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        View v = inflate.inflate(layoutId, null);
     ...
     * resource. The layout must have a {@link TextView} com id message
     *
     * @param context The context to use. Usually your
     *                {@link Activity} object.
     * @param resId   The resource id of the string resource to use. Can be
     ...
     */
    private AppMsg setAnimation(Animation inAnimation, Animation outAnimation) {
     ...
     *
     */
    private void setParent(ViewGroup parent) {
        mParent = parent;
    }
